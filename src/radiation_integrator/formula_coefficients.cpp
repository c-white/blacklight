  ...
  for (int m = 0; m < image_resolution; m++)
    for (int l = 0; l < image_resolution; l++)
    {
      ...
      if (fallback_nan and sample_flags(m,l))
      {
        ...
        {
          j_i(m,l,n) = std::numeric_limits<double>::quiet_NaN();
          alpha_i(m,l,n) = std::numeric_limits<double>::quiet_NaN();
        }
        continue;
      }
      ...
      for (int n = 0; n < num_steps; n++)
      {
        ...
        double k_0 = sample_dir(m,l,n,0);
        double k_1 = sample_dir(m,l,n,1);
        double k_2 = sample_dir(m,l,n,2);
        double k_3 = sample_dir(m,l,n,3);
        ...
        j_i(m,l,n) = j_nu_fluid_cgs / (nu_fluid_cgs * nu_fluid_cgs);
        ...
        alpha_i(m,l,n) = alpha_nu_fluid_cgs * nu_fluid_cgs;
      }
    }
  return;
}
