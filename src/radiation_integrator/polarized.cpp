    ...
    for (int m = 0; m < image_resolution; m++)
      for (int l = 0; l < image_resolution; l++)
      {
        ...
        for (int n = 0; n < num_steps; n++)
        {
          ...
          double alpha_s[4] = {};
          alpha_s[0] = alpha_i(m,l,n);
          alpha_s[1] = alpha_q(m,l,n);
          alpha_s[3] = alpha_v(m,l,n);
          ...
          else
          {
            ...
            if (optically_thin)
            {
              ...
              for (int a = 0; a < 4; a++)
                for (int b = 0; b < 4; b++)
                  oo[a][b] = exp * (0.5 * (mm_1[a][b] + mm_4[a][b]) * cosh + 0.5 * (mm_1[a][b]
                      - mm_4[a][b]) * cos - mm_2[a][b] * sin - mm_3[a][b] * sinh);
            }
